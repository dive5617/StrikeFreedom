    ...
    public class CrashReportMgr
    {
        ...
        void CurrentDomain_UnhandledException(object sender, UnhandledExceptionEventArgs e)
        {
            ...
            //{
                ...
                string pFind_license = "pFind.license";
                string user_information = ConfigHelper.get_userInformation_inLicense(pFind_license);
        ...
        {            
            ...
            try
            {
                MiniDump.TryDump("CrashReportDmp.dmp", pFind.MiniDump.MiniDumpType.Normal);
            }
            catch (Exception ex)
            {
