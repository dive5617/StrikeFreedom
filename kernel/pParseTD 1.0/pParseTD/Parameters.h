...
const long long MAX_FILE_SIZE = 500*1024*1024;
...
const int IPV_MASSMAX = 10000;
const int IPV_PEAKMAX = 19;
...
const int setSize = 2;
const string HighPreSet[setSize] = {"FTMS", "Q-TOF"};
const string LowPreSet[setSize] = {"ITMS", ""};
