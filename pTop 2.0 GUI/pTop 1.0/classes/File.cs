    ...
    public class File:INotifyPropertyChanged,IDataErrorInfo              //12个属性
    {
        ...
        public void setInstrument()
        {
            switch (instrument_index)
            {
                ...
                case (int)InstrumentOptions.ETHCD: instrument = "ETHCD"; break;
                case (int)InstrumentOptions.ETCID: instrument = "ETCID"; break;
        ...
        public void setInstrument_index()
        {
            ...
            else if (instrument.Equals("ETHCD"))
            {
                instrument_index = (int)InstrumentOptions.ETHCD;
            }
            else if (instrument.Equals("ETCID"))
            {
                instrument_index = (int)InstrumentOptions.ETCID;
            }
        }
