...
namespace pTop.classes
{
    class Message_Help
    {
        ...
        public static string COPY_OK = "Please paste (Ctrl+V) the registration information into the body of your e-mail and send it to ptop@ict.ac.cn.";
        ...
        public static string EXPIRY_DATE = "The software was due to expire at the end of 2015, please download and install it again.";
    }
}
